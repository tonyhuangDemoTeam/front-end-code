<template>
  ...
  <el-aside width="300px">
        ...
        <el-row>
            <el-col class="table-txt">Region:</el-col>
            <el-col>
                <el-checkbox-group v-model="sizeForm.region" size="mini">
                    <el-checkbox label="China"></el-checkbox>
                    <el-checkbox label="HongKong"></el-checkbox>
       ...
       <el-row>
            <el-col class="table-txt">Type:</el-col>
            <el-col>
                <el-radio-group v-model="sizeForm.type" size="mini">
                    <el-radio border label="Individual"></el-radio>
                    <el-radio border label="Entity"></el-radio>
                </el-radio-group>
            </el-col>    
        </el-row>
    ...
    <el-main>
        ...
        <el-row>
            ...
            <el-col :span="24">
                ...
                <div id="chartPie" style="width:100%; min-height:400px;"></div>
            </el-col>
        </el-row>
    </section></el-main>
  </el-container>
