    ...
    <section id="element-to-print">
        <el-row v-loading="loading">
            ...
            <el-col :span="24">
                ...
                <el-table :data="equityTable" show-summary sum-text="Total" size="small" class='cp-table' :header-cell-style="tableHeaderColor" style="width: 100%">
            ...
            <el-col :span="24">
                ...
                <el-table :data="fixedTable" show-summary sum-text="Total" class='cp-table' size="small" :header-cell-style="tableHeaderColor" style="width: 100%">
                    <el-table-column prop="name" label="Product Name">
                    </el-table-column>
                    <el-table-column fixed="right" prop="quantity" label="Quantity">
                    </el-table-column>
            ...
            <el-col :span="24">
                ...
                <el-table :data="fxTable" show-summary sum-text="Total" class='cp-table' size="small" :header-cell-style="tableHeaderColor" style="width: 100%">
            ...
            <el-col :span="24">
                ...
                <el-table :data="structureTable" show-summary sum-text="Total" class='cp-table' size="small" :header-cell-style="tableHeaderColor" style="width: 100%">
                    <el-table-column prop="name" label="Product Name">
                    </el-table-column>
                    <el-table-column fixed="right" prop="quantity" label="Quantity">
                    </el-table-column>
            ...
            <el-col :span="24">
                ...
                <el-table :data="SummaryTable" fixed class='cp-table' size="small" :header-cell-style="tableHeaderColor" style="width: 100%">
